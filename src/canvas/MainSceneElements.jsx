...
const MainSceneElements = React.memo(() => {
  ...
  const plant1clone2 = useMemo(() => plants1.scene.clone(), [plants1]);
  ...
  return (
    <>
      <group position={[0, -6, -10]} scale={ratioScale} castShadow receiveShadow>
        ...
        <primitive position={[-10, 0, -2]} rotation={[0, -60, 0]} scale={15} object={plant1clone2} />
        <primitive position={[-8, -2, 0]} rotation={[0, -170, 0]} scale={0.03} object={plant2clone2} />
